<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HeaderFooter.Master" CodeBehind="ArtistProfileEdit.aspx.cs" Inherits="WebAssignment.ArtistProfileEdit" %>
...
{%>
    ...
    <center>
        ...
        <br />
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="'Montserrat', sans-serif" Font-Size="XX-Large" ForeColor="Black" style="padding-top:50px;padding-bottom:100px;" BorderColor="Aqua" BorderStyle="None" BorderWidth="5px" Height="16px"> ERROR 404</asp:Label>
        <br />
...
%>
    ...
    <br />
        <asp:Button ID="Button1" runat="server" OnClick="LinkButton2_Click" Text="Confirm Edit" class="buttondesign"/>
        <br />
        <asp:Button ID="Button3" runat="server" Text="Edit Password" CssClass="buttondesign" OnClick="Button3_Click" />
        <br />
        <asp:Button ID="Button2" runat="server" OnClick="LinkButton3_Click" Text="Cancel" class="buttondesign"/>
        </div>
    </center>
    <% } %>
</asp:Content>