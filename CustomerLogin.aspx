<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HeaderFooter.Master" CodeBehind="CustomerLogin.aspx.cs" Inherits="WebAssignment.CustomerLogin" %>
...
background-image: linear-gradient(rgba(255,255,255,0.7), rgba(255,255,255,0.7)), url("../imgs/loginbg.jpg");
}
    </style>
